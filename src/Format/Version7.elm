module Format.Version7 exposing (Graph, Node, Edge, toJSGraph, fromJSGraph, version)
...
pullbackEdge : Int -> Edge
pullbackEdge z = Edge "" emptyArrowStyle True z
...
fromEdgeLabel e = 
   case e.details of
       PullbackEdge -> pullbackEdge e.zindex
...
toEdgeLabel { label, style, isPullback, zindex } = 
   { selected = False, weaklySelected = False,
     zindex = zindex,
     details = 
       if isPullback then PullbackEdge else
